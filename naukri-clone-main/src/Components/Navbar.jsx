         ...
         style={{ backgroundColor: "#f3f2f2" }}>
                <header className={styles.header}>
                    <ul className={styles.navbar} >
                        ...
                        <li><span> {data.length !== 0 ? <Link style={{ color: 'white' }} to="/profile">{data[0].name} </Link> : <Link style={{ color: '#4a90e2', border: "1px solid #4a90e2", padding: "6px",textAlign: "center", paddingRight: "15px", paddingLeft: "15px" ,borderRadius: "20px" }} to="/login">Login</Link>} </span></li>
